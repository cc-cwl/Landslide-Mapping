...
class MaskFormer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.sample1=nn.Conv2d(3, 12, kernel_size=2,stride=2)
        self.sample2=nn.Conv2d(12, 12, kernel_size=2,stride=2)
        self.sample3=nn.Conv2d(268, 256, kernel_size=1,stride=1)
...
'''
#original and with frequency in transformer only
@META_ARCH_REGISTRY.register()
class MaskFormer(nn.Module):
    """
    Main class for mask classification semantic segmentation architectures.
